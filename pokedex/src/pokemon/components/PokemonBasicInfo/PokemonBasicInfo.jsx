import { convertDecimetersToFeet } from '../../utils/convertDecimetersToFeet';
import { convertHectogramsToLbs } from '../../utils/convertHectogramsToLbs';
import formatHeightInFeet from '../../utils/formatHeightInFeet';
...
export default function PokemonBasicInfo({ pokemon, species }) {
    return <div className='basic-info-container'>
        ...
        <div className='basic-info-bottom'>
            ...
            <p>Height: {formatHeightInFeet(convertDecimetersToFeet(pokemon.height))}</p>
        </div>
    </div>
}